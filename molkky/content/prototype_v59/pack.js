...
MolkkyContent.register({
  id:'prototype-v59',version:59,label:'LOCAL MATCH PROTOTYPE v59 / v61 SYSTEM',
  images:{
    ...
    throwingMolkky:'objects/molkky/official/throwing_molkky.svg?v=61'
  },
  audio:{
  ...
  text:{
    page:{title:'MÖLKKY GAL ARCADE — LOCAL MATCH v61',badge:'LOCAL MATCH v61'},
    ui:{scoreLabel:'SCORE',targetLabel:'TARGET',targetValue:'50 JUST',miss:'MISS × {misses}',turn:'TURN {turn}',power:'POWER',accuracy:'ACCURACY',statusTip:'投法を選択 → スキットルを狙う → POWER → ACCURACY → THROW',ready:'READY',coachTag:'GAL実況・うるさめ',initialBubble:'ナイスー！'},
    throwStyles:{label:'THROW STYLE',soft:'SOFT',softHint:'一本抜き',standard:'STANDARD',standardHint:'基本投法',smash:'SMASH',smashHint:'連鎖重視'},
