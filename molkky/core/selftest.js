...
var vs=AudioManager.getVoices(ch.voiceSet),se=AudioManager.getSe('default');if(!vs||vs.items.length!==8)return fail('voice set');if(!se||!se.wood||!se.whoosh||!se.land)return fail('SE set');
if(!window.__BGM_V29__||typeof __BGM_V29__.start!=='function'||typeof __BGM_V29__.state!=='function')return fail('v29 engine');
